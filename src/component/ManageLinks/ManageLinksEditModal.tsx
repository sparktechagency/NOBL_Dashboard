...
import manageLinkThumbnail from "../../assets/Images/dashboard/manageLinkThumbnail.png";

const { Option } = Select;

interface ManageLinksEditModalProps {
  isModalOpen: boolean;
  setIsModalOpen: React.Dispatch<React.SetStateAction<boolean>>;
}

const ManageLinksEditModal: React.FC<ManageLinksEditModalProps> = ({
  isModalOpen,
  setIsModalOpen,
}) => {
  const handleCancel = () => {
    ...
    >
      ...
      <div className=" bg-white rounded-b-lg space-y-5 p-16">
        <div className="relative">
          <img src={manageLinkThumbnail} className="w-full " alt="" />
          <Button className="text-[#043249] font-popping text-lg font-medium absolute top-3 right-3">
            <svg
              width="18"
              height="18"
              viewBox="0 0 18 18"
        ...
        <div className="space-y-2">
          ...
          <div>
            ...
            <Input
              placeholder="https://www.facebook.com/folders/16y4_XlZtMk8bBlDK9XZUPfCFl2Q_bkCW"
...
export default ManageLinksEditModal;
