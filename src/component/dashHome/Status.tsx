    ...
    <div className="rounded-xl">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4  mt-[12px]">
        {cardData.map((card, index) => (
          <div
            key={index}
            className="bg-white w-[360px] py-6 flex justify-center items-center rounded-lg shadow-sm"
          >
            <div className="flex flex-col justify-center items-center text-center">
              <div className="mb-3">{card.icon}</div>
              <p className="py-1 font-roboto text-[#777777] font-normal text-base">
                {card.title}
              </p>
              <h3 className="font-roboto font-bold text-[28px]">
                {card.value}
              </h3>
            </div>
          </div>
